			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="crumina-module crumina-info-box info-box--numbers">
						...
						<p class="info-box-text">We specialize in services that range from web design and development, software development, cyber security, big data, artificial intelligence, data analysis, network administration, machine learning, server and database management services.
						</p>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="crumina-module crumina-info-box info-box--numbers">
						...
						<p class="info-box-text">Our core strength is in our engineering prowess. Designing software isn't like adding a coat of paint. A well-built software thinks about users and their needs. We entrain our over 14 years of user behavior analysis and human interaction into every project.
						</p>
					</div>
				</div>
			</div>
				...
				<div class="crumina-module crumina-module-img-bottom">
					<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
						<div class="crumina-module crumina-heading">
							...
							<h2 class="heading-title">Let everyone out there know why we are one of the best</h2>
							<div class="heading-text">Checkout some of our previous work. Over the years, we have rendered services to individuals and businesses! We have created quite a good number of Software Solutions.
							</div>
						</div>
					</div>
